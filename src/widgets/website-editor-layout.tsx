...
export default function WebsiteEditorLayout({ websiteId }: WebsiteEditorLayoutProps) {
  const router = useRouter();
  const { currentWebsite, getWebsiteById, setCurrentWebsite } = useWebsiteStore();
  ...
  const handlePageSelect = (page: Page | null) => {
    if (page && currentPage?.id === page.id) return; // 같은 페이지면 무시
