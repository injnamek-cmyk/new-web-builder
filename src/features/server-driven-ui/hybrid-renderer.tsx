  ...
  if (element.type === "container") {
    ...
    switch (element.layoutMode) {
      case "flex":
        ...
        containerLayoutStyle.flexDirection =
          element.flex?.flexDirection || "row";
        containerLayoutStyle.justifyContent =
          element.flex?.justifyContent || "flex-start";
      ...
      case "grid":
        ...
        containerLayoutStyle.gridTemplateColumns =
          element.gridProps?.gridTemplateColumns || "1fr";
        containerLayoutStyle.gridTemplateRows =
          element.gridProps?.gridTemplateRows || "auto";
